        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 py-3">
              ...
              <li class="breadcrumb-item active fw-light" aria-current="page"><a class="fw-light" href="remoteOrders.php">Remote Orders /</li>
              <li class="breadcrumb-item active fw-light" aria-current="page">&nbsp Order Detail  </li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <section class="tables">
        <div class="container-fluid">
          <div class="row">
            ...
            <?php
              $id = $_GET['id'];
              $sql = "SELECT * FROM remote_orders WHERE id=$id";
              ...
              if($res==TRUE)
              {
                ...
                {
                  echo '<script type="text/javascript"> window.location = "remoteOrders.php" </script>';
                }
              }
