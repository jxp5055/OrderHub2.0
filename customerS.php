    ...
    <div class="page">
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 py-3">
              ...
              <li class="breadcrumb-item active fw-light" aria-current="page">Pickup Detail  </li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <header class="py-4">
        <div class="container-fluid py-2">
          <h1 class="h3 fw-normal mb-0">Pickup Details</h1>
        </div>
      </header>
            ...
            <div class="col-lg-20">
              <div class="card">
                ...
                <div class="card-body">
                      ...
                      <tbody>
                          ...
                          <td>
                            <div class="col-sm-9">
                              <select class="form-select mb-3" name="account">
                                <option>Store Received</option>
                                <option>Store Not Received</option>
                        ...
                        <tr>
                          <td>
                              SKU #: A1X2D</br>
                              Color Code: N88</br>
                              Description: 3D-Logo Baseball Cap
                          </td>
                          <td>
                            <div class="col-sm-9">
                              <select class="form-select mb-3" name="account">
                  ...
                  <p style="color:red; padding-top: 10px;">(Please remember to attain signature below.)</p>
                </div>
