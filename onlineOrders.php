    ...
    <div class="page">
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 py-3">
              ...
              <li class="breadcrumb-item active fw-light" aria-current="page">Online Orders  </li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <header class="py-4">
        <div class="container-fluid py-2">
          <h1 class="h3 fw-normal mb-0">Online Orders</h1>
        </div>
      </header>
                              ...
                              if($count>0)
                              {
                                ...
                                while($rows=mysqli_fetch_assoc($res))
                                {
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="customerO.php"><?php echo $id; ?></a></td>
                                    ...
                                    <td>
                                        <a href="<?php echo "deleteO.php"; ?>?id=<?php echo $id; ?>" class="btn btn-primary mb-3" style="color:red;background-color:red">Delete</a>
                                        <a href="<?php echo "customerO.php"; ?>?id=<?php echo $id; ?>" class="btn btn-primary mb-3" style="margin-right: 10px">Update</a>
                                    </td>
                                  </tr>
