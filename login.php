<?php
  ...
  if(isset($_POST['loginUsername']))
  {
    ...
    $sql="SELECT * FROM tbl_admin WHERE username='".$uname."'AND password='".$password."'limit 1";
            ...
            <div class="card">
              <div class="card-body p-5">
                <header class="text-center mb-5">
                  ...
                  <h4 class="text-m text-primary text-uppercase">Orderhub<strong class="text-gray-400">2.0</strong></h4>
                  <p class="text-gray-500 fw-light">Sign In</p>
                </header>
                <form method="POST" action="">
                  <div class="row">
                    ...
                    <div class="col-12 text-center">
                      <button class="btn btn-primary mb-3" id="login" type="submit">Login</button><br><a class="text-xs text-paleBlue" href="#!">Forgot Password?  </a><br><span class="text-xs mb-0 text-gray-500">Do not have an account?  </span><a class="text-xs text-paleBlue ms-1" href="register.php"> Signup</a>
                    </div>
                  </div>
                </form>
              </div>
